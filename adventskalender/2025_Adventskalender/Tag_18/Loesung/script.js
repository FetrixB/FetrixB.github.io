...
function toggleFilter() {
  filterLongOnly = !filterLongOnly;
  filterToggle.textContent = filterLongOnly ? "Filter aktiv: Zeige Giganten" : "Filter: Nur extra lange anzeigen";
  logLoop(filterLongOnly ? "Filter() zeigt nur Zapfen über 180 cm." : "Filter entfernt – alle Zapfen sichtbar.");
  renderAll();
}
