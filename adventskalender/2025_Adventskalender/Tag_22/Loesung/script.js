document.addEventListener("DOMContentLoaded", () => {
  ...
  async function requestCompletion() {
    ...
    // Optional: Add API key if provided for enhanced features
    if (chatState.apiKey) {
    ...
    if (!reply) {
      throw new Error("Die KI hat keine Antwort geschickt.");
    }
  ...
  async function handleChatSubmit(event) {
    ...
    // Optional: API-Key kann für erweiterte Features verwendet werden
