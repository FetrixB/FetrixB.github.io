/*
 * Frosttempel Controller
 * - Regelt Blur über CSS-Custom-Properties
 * - Schaltet Glow an/aus
 * - Tauscht Themenfarben für verschiedene Lichtstimmungen
 */
...
const applyTheme = (themeKey) => {
  ...
  root.style.setProperty("--glow-strength", document.documentElement.classList.contains("glow-muted") ? "0.12" : "0.55");
